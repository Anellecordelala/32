        ...
        { 
                ...
                !String.IsNullOrEmpty(ColdStars.Text))
            {
                    ...
                    Int32.TryParse(ColdGarland.Text, out int coldGarland) & Double.TryParse(SumStars.Text, out double sumStars) & Int32.TryParse(ColdStars.Text, out int coldStars))
                {
                    ...
                    {
                        double sum = Math.Round((sumTree * coldTree + sumTinsel * coldTinsel + sumBall * coldBall + sumGarland * coldGarland + sumStars * coldStars), 3);
                        SumTextBox.Text = $"{sum}";
                    ...
                    else
                    {
                        ...
                        SumChristmasTree.Clear();
                        ColdChristmasTree.Clear();
                        SumTinsel.Clear();
                        ColdTinsel.Clear();
                        SumBall.Clear();
                        ColdBall.Clear();
