...
namespace _3
{
    public partial class Form1 : Form
    {
        ...
        private void Параметр1_TextChanged(object sender, EventArgs e)
        {

        }
        private void Параметр2_TextChanged(object sender, EventArgs e)
        {

        }
        private void Параметр3_TextChanged(object sender, EventArgs e)
        {

        }
        private void Параметр4_TextChanged(object sender, EventArgs e)
        {

        }
        private void Результат_TextChanged(object sender, EventArgs e)
        {
        ...
        {
            Form2 newF = new Form2(); // созадние объекта класса Form2
